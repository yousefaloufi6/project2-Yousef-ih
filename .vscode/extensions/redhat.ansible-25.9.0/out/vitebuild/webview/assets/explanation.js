import { d as defineComponent, f as ref, c as createElementBlock, o as openBlock, a as createBaseVNode, B as normalizeClass, v as vscodeApi, j as watch, g as createCommentVNode, t as toDisplayString, h as createTextVNode, i as createVNode, u as unref, E as toRaw, p as createApp } from "./vscode.js";
...
const sortMapEntriesByKey = (a, b2) => a.key < b2.key ? -1 : a.key > b2.key ? 1 : 0;
class Schema {
...
function getObjectKeys(content) {
  try {
    const parsedAnsibleDocument = parse(content);
...
const _hoisted_1$1 = { class: "stickyFeedbackContainer" };
const _hoisted_2$1 = { class: "feedbackContainer" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("vscode-button", {
            class: normalizeClass(["iconButton", { "iconButtonSelected": selectedFeedback.value === "thumbsUp" }]),
            appearance: "icon",
            id: "thumbsup-button",
            onClick: handleThumbsUp,
            disabled: selectedFeedback.value
          }, _cache[0] || (_cache[0] = [
            createBaseVNode("span", { class: "codicon codicon-thumbsup" }, null, -1)
          ]), 10, _hoisted_3$1),
          createBaseVNode("vscode-button", {
            class: normalizeClass(["iconButton", { "iconButtonSelected": selectedFeedback.value === "thumbsDown" }]),
            appearance: "icon",
            id: "thumbsdown-button",
            onClick: handleThumbsDown,
            disabled: selectedFeedback.value
          }, _cache[1] || (_cache[1] = [
            createBaseVNode("span", { class: "codicon codicon-thumbsdown" }, null, -1)
          ]), 10, _hoisted_4$1)
        ])
      ]);
    };
...
const FeedbackBox = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ab5049b1"]]);
const _hoisted_1 = {
  key: 0,
  id: "icons"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ExplanationApp",
  setup(__props) {
    provideVSCodeDesignSystem().register(allComponents);
    const loadingExplanation = ref(true);
    const noTasksInPlaybook = ref(false);
    const explanationType = ref(null);
    const playbookData = ref({ content: null, fileName: null });
    const roleData = ref({ files: [], roleName: null });
    const errorMessage = ref(null);
    const explanationHtml = ref(null);
    const explanationId = v4();
    ...
    vscodeApi.on("setPlaybookData", (data) => {
    ...
    vscodeApi.on("errorMessage", (message) => {
      loadingExplanation.value = false;
    ...
    return (_ctx, _cache) => {
      return loadingExplanation.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[0] || (_cache[0] = createBaseVNode("span", { class: "codicon codicon-loading codicon-modifier-spin" }, null, -1)),
        playbookData.value.fileName ? (openBlock(), createElementBlock("span", _hoisted_2, " Generating the explanation for " + toDisplayString(playbookData.value.fileName.split("/").at(-1)), 1)) : createCommentVNode("", true),
        roleData.value.roleName ? (openBlock(), createElementBlock("span", _hoisted_3, " Generating the explanation for role: " + toDisplayString(roleData.value.roleName), 1)) : createCommentVNode("", true)
      ])) : errorMessage.value ? (openBlock(), createElementBlock("div", _hoisted_4, [
        createBaseVNode("p", null, [
          _cache[1] || (_cache[1] = createBaseVNode("span", { class: "codicon codicon-error" }, null, -1)),
          createTextVNode("  " + toDisplayString(errorMessage.value), 1)
        ])
      ])) : noTasksInPlaybook.value ? (openBlock(), createElementBlock("div", _hoisted_5, _cache[2] || (_cache[2] = [
        createBaseVNode("p", null, [
          createBaseVNode("span", { class: "codicon codicon-info" }),
          createTextVNode("  Explaining a playbook with no tasks in the playbook is not supported. ")
        ], -1)
      ]))) : explanationHtml.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
        createBaseVNode("div", {
          class: "explanation",
          innerHTML: explanationHtml.value
        }, null, 8, _hoisted_7),
        createVNode(FeedbackBox, { explanationId: unref(explanationId) }, null, 8, ["explanationId"])
      ])) : (openBlock(), createElementBlock("div", _hoisted_8, _cache[3] || (_cache[3] = [
        createBaseVNode("p", null, "No explanation available.", -1)
      ])));
    };
  }
});
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dabbe251"]]);
